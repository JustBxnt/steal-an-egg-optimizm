-- ========================================================
-- EGG AREA TAGGER - MANUAL TAGGING
...
local CONFIG = {
    TagRadius = 300,  -- Tag eggs within 300 studs
    ESPEnabled = true,
    ShowDistance = true,
    TextSize = 14,
}
...
local function exportTags()
    ...
    output = output .. "-- Total eggs tagged: " .. (#eggTags) .. "\n\n"
...
buttonsFrame.Position = UDim2.new(0, 10, 0, 210)
buttonsFrame.BackgroundTransparency = 1
buttonsFrame.Parent = mainFrame

-- Create area buttons
local areas = {"Start", "Forest", "Lake", "Snow", "Desert", "Jungle", "Volcano", "Cosmic"}
local buttonHeight = 35
local buttonSpacing = 5

for i, area in ipairs(areas) do
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0.48, 0, 0, buttonHeight)
    
    -- Two columns layout
    local col = (i - 1) % 2
    local row = math.floor((i - 1) / 2)
    btn.Position = UDim2.new(col * 0.52, 0, 0, row * (buttonHeight + buttonSpacing))
...
clearBtn.Position = UDim2.new(0, 10, 0, 420)
...
exportBtn.Position = UDim2.new(0, 10, 0, 467)
...
espToggle.Position = UDim2.new(0.52, 0, 0, 467)
    ...
    while screenGui.Parent do
        ...
        for area, count in pairs(areaCounts) do
            if count > 0 then
                ...
                statsText = statsText .. area .. ": " .. count .. " eggs"
            end
        end
        
        if statsText == "" then
            statsLabel.Text = "No eggs tagged yet\n\nWalk to an area and click the button!"
        else
...
print("========================================")
print("✅ EGG AREA TAGGER LOADED!")
print("Instructions:")
print("1. Walk to an area (e.g. Volcano)")
