-- ========================================================
-- EGG AREA TAGGER V3 - COMPACT GUI
...
minimizeBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        ...
        for _, child in pairs(mainFrame:GetChildren()) do
            if child ~= titleLabel and child ~= minimizeBtn and child ~= frameCorner and child ~= frameStroke then
                child.Visible = false
            end
        end
    else
...
clearBtn.Position = UDim2.new(0, 10, 0, 365)
...
-- Copy & ESP Toggle - SIDE BY SIDE
local copyBtn = Instance.new("TextButton")
copyBtn.Size = UDim2.new(0.64, -5, 0, 30)
copyBtn.Position = UDim2.new(0, 10, 0, 405)
...
espToggle.Position = UDim2.new(0.64, 5, 0, 405)
...
-- Enable dragging on title and minimize button
enableDrag(titleLabel)
enableDrag(minimizeBtn)
...
game:GetService("UserInputService").InputChanged:Connect(function(input)
    if input == dragInput and dragging then
        ...
        -- Update stored position for minimize
        originalPos = mainFrame.Position
    end
end)

print("========================================")
print("✅ EGG AREA TAGGER V3 LOADED!")
print("Tag radius: 30 studs")
print("Click minimize (−) to hide GUI")
print("========================================")
